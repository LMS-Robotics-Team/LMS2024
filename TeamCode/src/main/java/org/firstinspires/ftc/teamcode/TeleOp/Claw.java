...
public class Claw {
    ...
    private static final double SERVO_BOTTOM_MIN = 0, SERVO_BOTTOM_DEFAULT = 0.5, SERVO_BOTTOM_MAX = 1, SERVO_BOTTOM_CHANGE = 0.003, SERVO_TOP_MIN = 0, SERVO_TOP_MAX = 0.15;
